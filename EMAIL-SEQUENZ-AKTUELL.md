# EndoCraft E-Mail-Sequenz — Stand 03.07.2026
*Live im Backend (server.js), versendet via Resend als marco@endocraft.app. Cron: taeglich 09:00.*

## Timing
| # | Trigger | Betreff |
|---|---------|---------|
| 1 | Sofort bei /free-Signup (+ Backfill nach Deploy) | Your D&D NPC pack is ready (and what's inside) |
| 2 | 3 Tage nach Mail 1 | A trick I use to make NPC voices stick at the table |
| 3 | 4 Tage nach Mail 2 | If you're prepping Curse of Strahd next... |
| 4 (VORSCHLAG) | Broadcast jetzt + ggf. T+14 im Drip | A free boss for your table. He is in no hurry. |
...
Unsubscribe: https://endocraft-production.up.railway.app/unsubscribe?token=<TOKEN>

---
## MAIL 2 — NPC-Dreizeiler (live)
Hey,
...
---
## MAIL 3 — Curse-of-Strahd-Pitch (live)
Hey,
...
---
## MAIL 4 — SLUGLORD (ENTWURF, wartet auf Marco-Feinschliff)
Betreff: A free boss for your table. He is in no hurry.
...
https://endocraft.app/free/sluglord/

[Bild: sluglord-wide.jpg — die Schnecke ueberm Dorf]
